<template>
    <section class="section-form-proyecto">
        <form class="form-proyecto" @submit.prevent="subirNuevoProyecto">
            <h2>Cargar Proyecto</h2>
            <input v-model.trim="form.nombre" type="text" name="nombre-proyecto" id="nombre-proyecto"
                placeholder="Nombre proyecto">
            <input v-model.trim="form.descripcion_breve" type="text" name="descripcion-corta-proyecto"
                id="descripcion-corta-proyecto" placeholder="Descripción breve">
            <textarea v-model.trim="form.descripcion" name="descripcion-proyecto" id="descripcion-proyecto" cols="30"
                rows="10" placeholder="Descripcion del proyecto"></textarea>
...
require("@/assets/css/admin-design/formProyecto.css")
